...
export class ReportesComponent implements OnInit {
  ...
  displayedColumns: string[] = ['fechaRegistro','numeroVenta',  'tipoPago', 'total', 'producto','cantidad','precio','netoProducto','ivaProducto','totalProducto'];
  ...
  exportarExcel() {
    ...
    let Heading = [['Numero Venta',  'Tipo Pago','Fecha Registro', 'Total', 'Producto','Cantidad','Precio','Precio Neto','Precio IVA','Precio Total']];
